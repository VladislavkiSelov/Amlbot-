...
<p>Склонировать проект на ваш компьютер с Github с помощью команды: git clone https://github.com/VladislavkiSelov/Reborn_UA.git](https://github.com/VladislavkiSelov/Amlbot-.git</p>
